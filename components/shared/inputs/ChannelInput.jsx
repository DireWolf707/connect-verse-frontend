...
import { useCreateMessage } from "@/state/apis/group"
import { SendHorizonalIcon } from "lucide-react"
import { useState } from "react"
import EmojiPickerButton from "../buttons/EmojiPickerButton"
import ChannelAttachmentUploadModal from "../modals/ChannelAttachmentUploadModal"
  ...
  return (
    ...
    >
      <div className="flex grow items-center">
        <ChannelAttachmentUploadModal channel={channel} />
        <Input
          required
          value={message}
