...
const RenderMessage = ({ message }) => {
  ...
  if (message.type === "image")
    return (
      <a
        href={message.media}
        target="_blank"
        className="relative block h-[160px] w-[240px] md:h-[240px] md:w-[320px]"
      >
  ...
  if (message.type === "video")
    return (
      <video
        src={message.media}
        alt="media"
        className="h-[160px] w-[240px] object-cover md:h-[240px] md:w-[320px]"
        controls
      />
    )
  ...
  return (
    <p className="text-main max-w-[225px] break-all text-[12px] leading-5 md:max-w-[340px] md:text-[14px] lg:max-w-[540px]">
      {message.content}
    </p>
  )
}
